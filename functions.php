...
function add_scripts() {
	...
	// load bootstrap css
	wp_enqueue_style( 'css-bootstrap', 'https://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/css/bootstrap.min.css' );
...
function new_nav_menu_items($items) {
	$homelink = '<li class="home"><a href="' . home_url( '/' ) . '"><span class="glyphicon glyphicon-home" aria-hidden="true"></span> &nbsp' . __('Home') . '</a></li>';
...
function new_excerpt_more($more) {
       global $post;
	return '&nbsp <a href="'. get_permalink($post->ID) . '"><span class="label label-primary">Read more...</span></a>';
}
